				...
				<div class = "col-md-4">
					...
					<form method = "POST" enctype = "multipart/form-data">
						<div class="form-group">
								...
								<input type="text" class="form-control" value = "<?php echo $fetch['hotel_name']?>"  name = "hotel_name" required/>
							</div>	
							<div class="form-group">
								<label>Room Type</label>
								<input type="text" class="form-control" value = "<?php echo $fetch['room_type']?>"  name = "room_type" required/>
							</div>
						<div class="form-group">
							<label>Room Number</label>
							<input type="text" class="form-control" value = "<?php echo $fetch['room_number']?>"  name = "room_number" />
						</div>
						<div class = "form-group">
							<label>Price </label>
