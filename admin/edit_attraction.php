	...
	<div class = "container-fluid">
		<div class = "panel panel-default">
			<div class = "panel-body">
				<div class = "alert alert-info">Edit Attraction Details</div>
				<br />
				<div class = "col-md-4">
					<?php
						$query = $conn->query("SELECT * FROM `attraction` WHERE `attraction_id` = '$_REQUEST[attraction_id]'") or die(mysqli_error());
					...
					<form method = "POST" enctype = "multipart/form-data">
						<div class="form-group">
								...
								<input type="text" class="form-control" value = "<?php echo $fetch['attraction_name']?>"  name = "attraction_name" required/>
							</div>	
						<div class="form-group">
						...
						<br />
						<div class = "form-group">
							<button name = "edit_attraction" class = "btn btn-warning form-control"><i class = "glyphicon glyphicon-edit"></i> Save Changes</button>
						</div>
					</form>
					<?php require_once '../admin_query/edit_query_attraction.php'?>
				</div>
			</div>
		</div>
	</div>
