	...
	<div class = "container-fluid">
		<div class = "panel panel-default">
			<div class = "panel-body">
				<div class = "alert alert-info">Add Resort</div>
				<br />
				<div class = "col-md-4">	
					<form method = "POST" enctype = "multipart/form-data">
                    <div class = "form-group">
							<label>Resort Name </label>
							<input type="text"  class="form-control" name = "resort_name" rows="2"></textarea>
						</div>
						<div class = "form-group">
							<label>Price </label>
						...
						<br />
						<div class = "form-group">
							<button name = "add_resort" class = "btn btn-info form-control"><i class = "glyphicon glyphicon-save"></i> Saved</button>
						</div>
					</form>
					<?php require_once '../admin_query/add_query_resort.php'?>
				</div>
			</div>
		</div>
	</div>
