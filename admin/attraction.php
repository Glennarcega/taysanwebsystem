...
<body>
	...
	<div class = "container-fluid">
		...
		<div>
				<a class = "btn btn-success" href = "add_attraction.php"><i class = "glyphicon glyphicon-plus"></i> Add Attraction</a>
				<br />
				<br />
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
					<?php
						$query = $conn->query("SELECT * FROM `attraction`") or die(mysqli_error());
						while($fetch = $query->fetch_array()){
					?>	
						<tr>
					    	<td><?php echo $fetch['attraction_name']?></td>
							<td><?php echo $fetch['descr']?></td>
                            <td><?php echo $fetch['location']?></td>
							<td><?php echo $fetch['transportation']?></td>
							<td><center><img src = "../photo/<?php echo $fetch['photo']?>" height = "50" width = "50"/></center></td>
							<td><center><a class = "btn btn-warning" href = "edit_attraction.php?attraction_id=<?php echo $fetch['attraction_id']?>"></i> Edit</a> <a class = "btn btn-danger" onclick = "confirmationDelete(this); return false;" href = "../admin_query/delete_attraction.php?attraction_id=<?php echo $fetch['attraction_id']?>"> Delete</a></center></td>
						</tr>
					<?php
						}
					?>	
