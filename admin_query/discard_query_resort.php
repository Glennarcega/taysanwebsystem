...
if (isset($_GET['transaction_id'])) {
    ...
    if (is_numeric($transaction_id)) {
        ...
        $query = "UPDATE transactionresort SET status = 'Discard' WHERE transaction_id = ?";
        ...
        if ($stmt = $conn->prepare($query)) {
            ...
            if ($stmt->execute()) {
                ...
                if ($stmt->affected_rows > 0) {
                    ...
                    echo "<script>alert('Transaction discarded successfully!'); window.location.href = '../admin/reserve_resort.php';</script>";
                } else {
