...
if (isset($_GET['transaction_id'])) {
    ...
    if (is_numeric($transaction_id)) {
        ...
        $query = "UPDATE transaction SET status = 'Check In' WHERE transaction_id = ?";
        ...
        if ($stmt = $conn->prepare($query)) {
            ...
            if ($stmt->affected_rows > 0) {
                ...
                echo "<script>alert('Transaction Checkin successfully!'); window.location.href = '../admin/checkin.php';</script>";
            } else {
